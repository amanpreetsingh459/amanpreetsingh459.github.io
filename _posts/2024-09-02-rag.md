...
Let's see a simplified example to grasp the concept of RAG. We will be using Google Gemini Model API to make call to the LLM. Any other llm can be used instead. Visit [Google AI Studio(Gemini)](https://aistudio.google.com/app/prompts/new_chat) page to [Get your Google AI Studio API key](https://ai.google.dev/api)
